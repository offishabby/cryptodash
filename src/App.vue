    ...
    <div class="container mx-auto flex flex-col items-center p-4">
      <div class="container">
        ...
        <template v-if="tickers.length">
          ...
          <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
            <div
              ...
              @click="select(t)"
              :class="{
                'border-purple-600': selectedTicker === t
              }"
              class="bg-gray-600 overflow-hidden rounded-lg border-gray-600 
            ...
            >
              <div class="px-4 py-5 sm:p-6 text-center">
                ...
                <dd class="mt-1 text-3xl font-medium text-gray-300">
                  {{ formatPrice(t.price) }}
                </dd>
              </div>
              ...
              <button
                ...
                class="flex items-center justify-center font-medium w-full bg-gray-800 px-4 py-4 sm:px-6 text-md text-gray-500 hover:text-gray-600 hover:bg-gray-700 hover:opacity-20 transition-all focus:outline-none "
              >
                <svg
                  class="h-5 w-5"
        ...
        <section v-if="selectedTicker" class="relative">
          <h3 class="text-lg leading-6 font-thin text-gray-300 my-8">
